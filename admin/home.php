            ...
            ?>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="peminjaman_edit.php?id=<?php echo $row['id_peminjaman'] ?>" class="btn btn-info">Edit</a>
                    <a href="peminjaman_delete.php?id=<?php echo $row['id_peminjaman'] ?>" class="btn btn-danger">Hapus</a>
