              ...
              ?>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="index.php?dashboard=peminjaman-add&id-buku=<?php echo $row['id_buku']; ?>"><button class="decoration-none btn-primary px-4 py-2 mr-auto font-weight-bold ">Pinjam</button></a>
