        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a href="?url=peminjaman"><button class="decoration-none btn-gradient-primary px-4 py-2 mr-auto font-weight-bold ">add +</button></a>
                    </div>
                </div>
                        ...
                        ?>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="?url=peminjaman-detail&id=<?php echo $row['id_peminjaman']; ?>">
