...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($buku['jumlah'] >= $jumlah_pinjam) {
    ...
    if ($query) {
      ...
      echo "<script>window.location ='pustakawan.php?url=peminjaman&notif=add-berhasil';</script>";
    }
  } else {
    echo "<script>window.location ='pustakawan.php?url=peminjaman-add&id-buku=$id_buku&error=error';</script>";
  }
}
// if ($query) {
//   echo "<script>
